            ...
            <div class="col-lg-6 mx-auto p-3 animate-in-down">
                <form class="p-4 bg-light" method="post" action="POST">
                    ...
                    <div style="height: 50px">
                        <a href="{{url('/seccionesLaCueva')}}" class="btn btn-outline-dark btn-lg btn-block">La Cueva</a>
                    </div>
                    <div style="height: 50px">
                        <a href="{{url('/seccionesFiladelfia')}}" class="btn btn-outline-dark btn-lg btn-block">Filadelfia</a>
                    </div>
                    <div style="height: 50px">
                        <a href="{{url('/seccionesMaruca')}}" class="btn btn-outline-dark btn-lg btn-block">Maruca</a>
                    </div>
                </form>
            </div>
        </div>
